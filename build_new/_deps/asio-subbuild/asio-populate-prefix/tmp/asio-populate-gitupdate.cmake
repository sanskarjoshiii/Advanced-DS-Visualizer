...
execute_process(
  COMMAND "C:/Program Files/Git/bin/git.exe" --git-dir=.git show-ref "asio-1-30-2"
  WORKING_DIRECTORY "C:/Users/prema/Desktop/Sanskar Engineering/4 sem/ADS/PROJECT/build_new/_deps/asio-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/prema/Desktop/Sanskar Engineering/4 sem/ADS/PROJECT/build_new/_deps/asio-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/prema/Desktop/Sanskar Engineering/4 sem/ADS/PROJECT/build_new/_deps/asio-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
